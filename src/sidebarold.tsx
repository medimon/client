...
import Etablissement from "./screens/Branches";
    ...
    <Box sx={{ display: "flex" }}>
          ...
          <Link to="etablissements">
            <ListItem disablePadding>
              <ListItemButton>
                ...
                <ListItemText primary="Établissements" />
              </ListItemButton>
            </ListItem>
          </Link>
          <Link to="units">
      ...
      <Main open={open}>
        ...
        <Routes>
          ...
          <Route path="/etablissements" element={<Etablissement />}></Route>
          <Route path="/units" element={<Units />}></Route>
          <Route path="*" element={<p>not found O.O</p>}></Route>
        </Routes>
      </Main>
    </Box>
  );
